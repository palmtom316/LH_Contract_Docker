...
const routes = [
	// PC Routes (Element Plus)
	{
		...
		children: [
			...
			{
				path: "warehouse/opening",
				name: "WarehouseOpening",
				component: () => import("@/views/warehouse/WarehouseOpening.vue"),
				meta: { title: "期初材料录入" },
			},
			{
	...
	// Mobile Routes (Vant UI)
	{
		...
		children: [
			...
			},
			{
				...
				component: () =>
					import("@/views/mobile/warehouse/WarehouseInbound.vue"),
				meta: { title: "入库" },
			},
			{
				...
				component: () =>
					import("@/views/mobile/warehouse/WarehouseOutbound.vue"),
				meta: { title: "出库" },
			},
			{
				...
				component: () =>
					import("@/views/mobile/warehouse/WarehouseTransfer.vue"),
				meta: { title: "调拨" },
			},
			{
			...
			},
			{
				...
				component: () =>
					import("@/views/mobile/warehouse/WarehouseInventory.vue"),
				meta: { title: "查库存" },
			},
			{
				...
				component: () =>
					import("@/views/mobile/warehouse/WarehouseHistory.vue"),
				meta: { title: "最近流水" },
			},
			{
			...
			},
			{
				...
				component: () =>
					import("@/views/mobile/warehouse/WarehouseLocation.vue"),
				meta: { title: "货位详情" },
			},
		],
	},
