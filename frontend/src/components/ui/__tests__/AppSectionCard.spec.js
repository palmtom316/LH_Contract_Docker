...
describe('AppSectionCard', () => {
  it('renders section cards with shared surface framing and slot-based header actions', () => {
    ...
    expect(sectionCardSource).toContain('transition: box-shadow 180ms ease, border-color 180ms ease;')
    expect(sectionCardSource).not.toContain('transform 180ms ease')
