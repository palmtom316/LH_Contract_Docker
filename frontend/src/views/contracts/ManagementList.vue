        ...
        <el-table-column label="操作" width="190" fixed="right">
          <template #default="scope">
            <div class="contract-list-actions">
              <el-button v-if="userStore.canManageManagementContracts" class="contract-list-action-button" type="primary" size="small" @click="handleEdit(scope.row)">编辑</el-button>
              <el-button class="contract-list-action-button" type="primary" size="small" @click="handleDetail(scope.row)">详情</el-button>
              <el-button v-if="userStore.canManageManagementContracts" class="contract-list-action-button" type="danger" size="small" @click="handleDelete(scope.row)">删除</el-button>
            </div>
          </template>
        </el-table-column>
      </el-table>
...
.management-page-panel :deep(.el-table__header th.el-table__cell) {
  background: color-mix(in srgb, var(--surface-panel-muted) 72%, var(--surface-panel) 28%);
}

.management-page-panel :deep(.el-table) {
