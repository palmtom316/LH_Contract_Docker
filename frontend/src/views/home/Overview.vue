        ...
        <el-card shadow="hover" class="period-card-modern">
          <template #header>
            <div class="card-modern-title-bar">
              ...
              <el-tag type="success" effect="light" round>近30天</el-tag>
            </div>
          </template>
      ...
      <el-col :xs="24" :lg="12">
        <el-card shadow="hover" class="period-card-modern">
          <template #header>
            <div class="card-modern-title-bar">
              <div class="title-left">
                <el-icon class="title-icon quarterly"><DataAnalysis /></el-icon>
                <span>近一季度经营状况</span>
              </div>
              <el-tag type="warning" effect="light" round>近90天</el-tag>
            </div>
          </template>
          <el-row :gutter="0" class="period-content-row">
            <el-col :span="12" class="period-col left-col">
...
import { getStats, getPeriodStats } from '@/api/dashboard'
